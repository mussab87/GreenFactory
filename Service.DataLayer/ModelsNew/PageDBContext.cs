...
{
    public partial class PageDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=MUSSAB\\SQLEXPRESS;Database=GreenFactoryDB;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductTbl>(entity =>
            {
                ...
                entity.Property(e => e.CreatedStamp).HasColumnType("datetime");
